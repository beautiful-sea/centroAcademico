		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview">
				...
				<ul class="treeview-menu">
					<li><a href="../../cadastrar.php"><i class="fa fa-circle-o"></i> Cadastrar</a></li>
					...
					<form role="form" action="../../controller/usuarios/cadastrar.php" method="POST">
						<div class="box-body">
							<div class="form-group">
								...
								<input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Digitar Email">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="password" name="senha" class="form-control" id="exampleInputPassword1" placeholder="Digitar senha">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Confirmar Senha</label>
								<input type="password" name="senha2" class="form-control" id="exampleInputPassword1" placeholder="Digitar senha novamente">
							</div>
						</div>
						<!-- /.box-body -->
						...
						<div class="box-footer">
							...
							<div <?php if($alert != '') echo "class='$alert'"; ?>>
								<p><?php if($mensagem != '') echo $mensagem;?></p>
							</div>
