					...
					<div class="modal-dialog modal-danger">
						<div class="modal-content">
							<div class="modal-header">
								...
								<form action="../../../controller/atletica/deletar_ultimas_fotos.php" method="POST">
									<div class="modal-body">
										<p><b style="font-size: 20px">Tem certeza que deseja remover a imagem?</b></p>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				if(isset($_GET['e']) && $_GET['e'] == 1){
					...
					echo "<div class='$alert col-md-3'>$mensagem</div>";
				}
				...
				<div class="row">
								...
								<div class="box-tools">
									<form role="form" action="#" method="POST" id="form_buscar_produto">
										<div class="input-group input-group-sm" style="width: 150px;">
											<input type="text" name="buscar_produto" class="form-control pull-right" placeholder="Título da imagem" id="consulta">
					...
					<div class="row">
						...
						<div class="content-header text-center">
							<h3 style="display: inline">Imagens no site</h3><i  class="fa fa-question-circle" style="padding: 5px" data-toggle="tooltip" data-placement="top" title="As imagens abaixo são exibidas no site na mesma quantidade(6) e ordem. (Passe o mouse na imagem e clique em 'editar' para alterar a ordem de exibição')."></i>
						</div>
						...
						//Se o tamanho da descricao original for menor do que ela encurtada
									...
									<img style="height:150px" src="../../../dist/img/atletica/ultimas_fotos/'.$value["foto"].'" alt="" class="img-fluid">
									<figcaption class="ms-thumbnail-caption text-center">
									<div class="ms-thumbnail-caption-content">
									<h3 class="ms-thumbnail-caption-title">'.$value["titulo"].'</h3>
									<p>'.$descricao.'</p>
									<a href="javascript:alterar('.$value["id"].')" data-tipo="alterar" class=" todas_imagens btn btn-white btn-raised color-bordo"><i
									class="fa fa-edit"></i> Escolher foto
									</a>
									</div>
									</figcaption>
									</figure>
						...
						<hr style="border: 1px solid maroon; margin: 20px 20px">
						<div class="col-md-6 offset-1 ">
							<!-- general form elements -->
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title" >Cadastro de Fotos </h3><i  class="fa fa-question-circle" style="padding: 5px" data-toggle="tooltip" data-placement="top" title="A última imagem cadastrada será a primeira na exibição. (É possível alterar a ordem das imagens exibidas). "></i>
								</div>
								<!-- /.box-header -->
								<!-- form start -->
								<form role="form" action="../../../controller/atletica/cadastrar_ultimas_fotos.php" enctype="multipart/form-data" method="POST">
									<div class="box-body">
										<div class="form-group">
											...
											<input type="text" name="titulo" required="" class="form-control" id="cadastro_titulo" placeholder="Digite o Título">
										</div>
										<div class="form-group">
											<label for="cadastro_descricao">Descrição</label>
											<input type="text" required="" name="descricao" class="form-control" id="cadastro_descricao" placeholder="Digite a Descrição">
										</div>
										<div class="form-group">
											<label for="cadastro_senha">Data</label>
											<input type="date" required="" name="data" class="form-control" id="cadastro_data" >
										</div>
										<div class="form-group">
											<label for="cadastro_senha">Foto</label>
											<input type="file" name="foto" class="form-control" id="cadastro_foto">
