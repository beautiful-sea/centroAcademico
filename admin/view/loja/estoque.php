        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        <div class="box-body">
                            <form role="form" action="../../controller/loja/editar_produtos.php" method="POST"
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><b style="font-size: 15px">R</b><i
                                                    class="fa fa-dollar-sign"></i></span>
                                            <input type="number" step="0.01" class="form-control" id="editar_valor"
                                                name="valor" placeholder="Digite o preço do produto">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><b style="font-size: 15px">R</b><i
                                                    class="fa fa-dollar-sign"></i></span>
                                            <input type="number" step="0.01" name="valor_socios"
                                                id="editar_valor_socios" class="form-control"
                                                placeholder="Digite o preço do produto">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="editar_descricao">Descrição</label>
                                        <textarea name="descricao" class="form-control" id="editar_descricao"
    ...
    <div class="wrapper">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../../view/usuarios/gerenciar.php"><i class="far fa-circle"></i> Gerenciar</a>
                            </li>
                        ...
                        <ul class="treeview-menu">
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu" style="display: none;">
                                    <li><a href="../conteudo/atletica/ultimas-fotos.php"><i class="far fa-images"></i>
                                            Últimas Fotos</a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div <?php if($alert != '' && isset($_GET['e'])) echo "class='$alert'"; ?>>
                    <?php if($mensagem != '' && isset($_GET['e'])) echo $mensagem; ?></div>
                <div <?php if($alert != '' && isset($_GET['d'])) echo "class='$alert'"; ?>>
                    <?php if($mensagem != '' && isset($_GET['d'])) echo $mensagem; ?></div>
                <div class="row">
                                ...
                                <div class="box-tools">
                                    <form role="form" action="#" method="POST" id="form_buscar_produto">
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <input type="text" name="buscar_produto" class="form-control pull-right"
                                                placeholder="Nome do Produto" id="consulta">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Adição de Produtos</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="../../controller/loja/cadastrar_estoque.php" method="POST"
                                enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
