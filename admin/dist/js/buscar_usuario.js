			...
			$.ajax({
				...
				success: function(data){
					...
					$.each(data, function(chave,valor){
						...
						<button class="btn btn-danger btn-remover"  title="Remover" data-remover="'+valor.id+'" data-toggle="modal" data-target="#modal-remover"><i class="fa fa-remove"></i></button></td></tr>';
					})
