		...
		<div class="ms-hero-page ms-hero-img-city2 ms-hero-bg-info mb-6">
			<div class="text-center color-white mt-6 mb-6 index-1">
				...
				<p class="lead lead-lg">Bem vindo a nossa vitrine online. Veja nossos produtos e aproveite para reservar o seu!
					<br> Obtenha descontos sendo sócio da Atlética.</p>
							...
							<form class="form-horizontal" id="Filters">
								...
								<fieldset>
									<div class="form-group no-mt">
										<div class="checkbox">
											<label>
												<input type="checkbox" value=".calca"> Calça </label>
										</div>
										<div class="checkbox">
											<label>
												<input type="checkbox" value=".bermuda"> Bermuda </label>
										</div>
										<div class="checkbox">
											<label>
												<input type="checkbox" value=".casaco"> Casaco </label>
										</div>
									</div>
								</fieldset>
								<fieldset>
									...
									<div class="form-group no-mt">
										<div class="checkbox">
											<label>
												<input type="checkbox" value=".caneca"> Caneca </label>
										</div>
									</div>
								</fieldset>
							...
							<div class="col-xl-4 col-md-6 mix bermuda apple" data-price="999.99" data-date="20160705">
								<div class="card ms-feature">
									<div class="card-body overflow-hidden text-center">
										<a href="loja-item.html"><img src="../admin/dist/img/loja/produtos/'.$produto['foto'].'" alt=""
										...
										<div>
											...
											<div class="d-inline">
												<h4 class="color-primary-inverse d-inline"><b>Sócio</b></h4></div>
											</div>
											<p>
												R$ '.$produto['valor'].' para não sócios
											</p>
										<a href="javascript:void(0)" class="btn btn-primary btn-sm btn-block btn-raised  no-mb"><i
